...
from utils_prompt import prepare_excel_for_pdf, convert_office_to_pdf, extract_image_pdf_3
...
for folder_id in FOLDER_IDS:
    try:
        ...
        print("ERROR: Could not access folder '{}': {}".format(folder_id, e))

print("-" * 80)
print("TOTAL FILES TO PROCESS: {}".format(len(all_paths)))
print("=" * 80)

if len(all_paths) == 0:
    print("WARNING: No files found in any folder. Exiting.")
    exit(0)
...
print("\n" + "=" * 80)
print("STARTING PROCESSING OF {} FILES FROM {} FOLDER(S)".format(total_files, len(FOLDER_IDS)))
print("=" * 80 + "\n")
...
print("=" * 80)
print("Total files processed: {}".format(processed_count))
print("Total cost: ${:.2f}".format(price_total))
print("=" * 80)
